...
$(document).ready(function() {
    ...
    let color = `linear-gradient(90deg, rgba(183, 2, 0, 1) ${vol * 100}%, rgba(183, 2, 0, 0.5) ${vol * 100}%)`;
...
$('input[type=range]').on('input keyup', function(e) {
    ...
    let xy = this.value;
    let percent = xy / max;
    let color = `linear-gradient(90deg, rgba(183, 2, 0, 1) ${percent * 100}%, rgba(183, 2, 0, 0.5) ${percent * 100}%)`;
